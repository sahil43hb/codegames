...
const NavItem = ({ item, level, parentId }) => {
    ...
    const itemIcon = item?.icon ? (
        <Icon
            ...
            sx={{
                color: isSelected ? theme.palette.dark.main : theme.palette.text.success,
                '&:hover': {
        ...
        <FiberManualRecordIcon
            sx={{
                color: isSelected ? theme.palette.success.main : theme.palette.text.success,
    ...
    const textColor = theme.palette.mode === 'dark' ? 'success.main' : 'text.success';
    const iconSelectedColor = theme.palette.mode === 'dark' && drawerOpen ? 'text.success' : 'success.main';
                            ...
                            sx={{
                                ...
                                ...(!drawerOpen &&
                                    level === 1 && {
                                        ...
                                        '&:hover': {
                                            bgcolor: theme.palette.mode === 'dark' ? theme.palette.success.main + 25 : 'success.light'
                                        },
                                        ...(isSelected && {
                                            bgcolor: theme.palette.mode === 'dark' ? theme.palette.success.main + 25 : 'success.light',
                                            '&:hover': {
                                                bgcolor: theme.palette.mode === 'dark' ? theme.palette.success.main + 30 : 'success.light'
                                            }
                                        })
                                    })
                            }}
