...
const NavCollapse = ({ menu, level, parentId }) => {
    ...
    const textColor = theme.palette.mode === 'dark' ? 'grey.400' : 'text.dark';
    const iconSelectedColor = theme.palette.mode === 'dark' && drawerOpen ? 'text.primary' : 'dark.main';
                                ...
                                sx={{
                                    ...
                                    ...(!drawerOpen &&
                                        level === 1 && {
                                            ...
                                            ...(isSelected && {
                                                bgcolor:
                                                    theme.palette.mode === 'dark' ? 'theme.palette.success.main + 25' : 'success.light',
                                                '&:hover': {
                                                    bgcolor:
                                                        theme.palette.mode === 'dark'
