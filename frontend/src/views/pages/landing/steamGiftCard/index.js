...
import SteamGiftDetail from './steamGiftDetail';
...
const SteamGiftCardPurchase = () => {
    ...
    useEffect(() => {
        const getPubgPageProducts = async () => {
            const response = await myAxios.get('/nonAuth/steam-gift-card-products');
...
export default SteamGiftCardPurchase;
