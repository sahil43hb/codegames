...
const SteamPage = () => {
    ...
    useEffect(() => {
        const getSteams = async () => {
            ...
            const response = await myAxios.get('/admin/get-products-with-module-name', { params: { moduleName: moduleName } });
                ...
                parentData && denominationData ? (
                    <>
                        ...
                        >
                            ...
                            <DeletePageModal open={open} handleOpen={handleOpen} handleClose={handleClose} moduleName={'Steam Page'} handleDelete={handleDelete} currentId={currentId} modalLoading={modalLoading} setModalLoading={setModalLoading} />
                        </MainCard>
