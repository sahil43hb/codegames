...
export default function Nintendo() {
    ...
    useEffect(() => {
        const getPlatformProducts = async () => {
            const response = await myAxios.get('/admin/get-products-with-module-name', { params: { moduleName: 'Nintendo' } })
    ...
    const handleRemove = async (product_id, index) => {
        const response = await myAxios.post('/admin/delete-Product-with-module-name', { id: product_id }, { params: { moduleName: 'Nintendo' } });
                    ...
                    (
                        <Grid>
                            ...
                            <TableContainer>
                                                                ...
                                                                <IconButton
                                                                    onClick={() =>
                                                                        navigate('/admin/update-multi-denominations', {
                                                                            state: { multiProduct: row, moduleName: 'Nintendo', navigationUrl: '/admin/nintendo-games' }
                                                                        })
                                                                    }
                                                                >
                                ...
                                <DeleteModal open={open} handleOpen={handleOpen} handleClose={handleClose} moduleName={'Nintendo Game'} handleDelete={handleRemove} index={currentIndex} id={currentId} modalLoading={modalLoading} setModalLoading={setModalLoading} />
                                {/* table pagination */}
                                <TablePagination
